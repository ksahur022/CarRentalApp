...
public class CancelBookingHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    private final BookingService bookingService;
    private final Gson gson;

    @Inject
    public CancelBookingHandler(BookingService bookingService) {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try {
            ...
            // Cancel booking
            BookingResponse serviceResponse = bookingService.cancelBooking(bookingId);
            ...
            errorResponse.put("message", "Error canceling booking: " + e.getMessage());
