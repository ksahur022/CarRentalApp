...
public class GetBookingDetailsHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    private final BookingService bookingService;
    private final Gson gson;

    @Inject
    public GetBookingDetailsHandler(BookingService bookingService) {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try {
            ...
            BookingDetailsResponse serviceResponse = bookingService.getBookingDetails(bookingId);
            ...
            if (serviceResponse.getStatusCode() != 200) {
                ...
                // Clear transient fields before serialization
            ...
            errorResponse.put("message", "Error retrieving booking details: " + e.getMessage());
